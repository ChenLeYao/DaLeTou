...
MobileSelect.prototype = {
	...
	init: function(config){
		...
		_this.ensureBtn.addEventListener('click',function(){
			...
			if(_this.triggerDisplayData){
				var positionT =  tempValue.lastIndexOf('-');
				tempValue = tempValue.substring(0,positionT) + '</tt></span>';
	...
	getInnerHtml: function(sliderIndex){
		...
		var inner =  "<span>"+_this.slider[sliderIndex].getElementsByTagName('li')[index].innerHTML+"<tt>-</tt></span>"
